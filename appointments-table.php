  ...
  <main id="main" class="main">
   ...
   <?php
    ...
    if (!isset($_SESSION['email'])) {
      ...
      $query="select * from appointment_requests where lemail='$lemail' and lpassword='$lpassword' and lawyerstatus='INTERESTED'";
      $result=mysqli_query($con,$query);
              ...
              echo"<table>";
                echo"<thead>";
                    echo"<tr>";
                      ...
                      echo"<th>Fee payment request</th>";
                      echo"<th>Requested Fee</th>";
                      echo"<th>Payment Status</th>";
                      echo"<th>Total Fee paid</th>";
                      echo"<th>Case Status update</th>";
                  ...
                  if($result && mysqli_num_rows($result) > 0) 
                  {
                    echo "<tbody>";
                      while($row = $result->fetch_assoc()) 
                      {
                        ...
                        <button class='button1' name='proceedpay'>Proceed</button> </form>
                        </td>";
                        ...
                        <input type='hidden' name='cemail' value='" . $row['cemail'] . "'>
                        <input type='hidden' name='cpassword' value='" . $row['cpassword'] . "'> 
                        <input type='text' name='casestatus' placeholder='case status?' required>
                        <button class='button1' name='casests'>Proceed</button> </form>
                        </td>";
                        echo "<td>" .($row['case_status'])."</td>";
                        echo "<td><a href='report.php?appointment_id=" .$row['appointment_id'] . "' class='button'>Report</a></td>";

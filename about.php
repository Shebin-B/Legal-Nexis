      ...
      <div class="row">
        <div class="col-md-5 offset-md-1">
          <div class="detail-box pr-md-2">
            ...
            <p class="detail_p_mt">
              Legal Nexis is a comprehensive freelance attorney hiring system designed to connect clients with the ideal lawyer for their legal needs. Whether seeking legal advice or hiring representation, users can easily find and engage top attorneys through our platform. Additionally, Legal Nexis supports lawyers in establishing and growing their practice, offering tools and resources to enhance their professional presence.            </p>
            </p>
        ...
        <div class="col-md-6 px-0">
          <div class="img-box ">
            <img src="images\home-imag2.jpg" class="box_img" alt="about img">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="info_detail">
              ...
              <p>
                Legal Nexis offers a streamlined way for clients to find the perfect lawyer through personalized matchmaking based on their specific legal needs and preferences.      </div>

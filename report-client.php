...
if (isset($_GET['appointment_id'])) {
    ...
    $lawyercontact = $row['lawyercontact'];
    $caseno = $row['case_number'];
    $lawyerplace = $row['lawyerplace'];
...
<div class="report-container">
        ...
        <div class="report-field">
            ...
            <span><?php echo htmlspecialchars($lawyername); ?></span>
        </div>
        <!-- <div class="report-field">
            <label>Bar Council ID:</label>
            <span><?php echo htmlspecialchars($barid); ?></span>
        </div> -->
        <div class="report-field">
            <label>Place:</label>
            <span><?php echo htmlspecialchars($lawyerplace); ?></span>
        </div>
        <div class="report-field">
            <label>Mobile:</label>
            <span><?php echo htmlspecialchars($lawyercontact); ?></span>
        </div>
        <div class="report-field">

...
if (isset($_POST["delete"])) 
            {
                ...
                $query1= "UPDATE client_registration SET status='$sts' WHERE email='$email' AND password='$password'";
                ...
                $result2 = mysqli_query($con, $query2);
                  ...
                  if($result1 && $result2)
                  {
                      echo "<script>alert('Your respose has been saved!');</script>";
                      header("Location:admin-client tables.php");
                      exit();
                  } 
...
<!-- 
  ...
  <main id="main" class="main">
   ...
   <?php
   include("connection.php");
   $query="select * from client_registration";
   $result=mysqli_query($con,$query);
   
  echo"<h2>Client Profiles</h2>";

...
<head>
  ...
  <link rel="stylesheet" href="clientformstyle.css?v=1.0">
  <!-- fonts style -->
...
<section class="service_section layout_padding">
  <div class="container2">
    ...
    <div class="form-group">
        ...
        <input type="text" id="caseno" name="caseno" required pattern="\d{1,3}/\d{4}" title="Please enter a valid case number (e.g., 324/2024)">
    </div>
    ...
    <div class="form-group">
        <button type="submit" name="submit">Register as user</button>
    </div>
</form>
...
if(isset($_POST["submit"]))
{
    ...
    $query="insert into client_registration values('$name','$contact','$case_no','$email','$address','$district','$city','$pin','$image_name','$password','$status')";
    ...
    if ($result1 && $result2) 
    {
      move_uploaded_file($image_tmp_name, "images/client_images/" . $image_name);

      echo "<script>alert('Registration successful! Welcome, $name!');</script>";

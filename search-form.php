...
<body class="sub_page">
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="search-name.php">Search by name</a>
                </li>
  ...
  <form method="POST" action="" enctype="multipart/form-data">
    <div class="search-container">
      <select id="speciality" class="search-field" name="speciality" required>
       ...
       <!-- <input type="text" placeholder="Qualification" class="search-field" name="qualification"> -->
  ...
  <?php
    include("connection.php");
        ...
        $query="select * from lawyer_registration where specialization='$speciality'";
